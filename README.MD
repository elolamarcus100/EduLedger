...
1.  Install frontend(root) dependencies:
    ...
    npm install
    ```
2.  Install backend dependencies (Express.js):
    ```bash
    cd backend
    npm install
    ```
...
**`0xb51fc31becE3850415Dc97eB2B06C30499E7D1bb`**

👉 Take a look at `EduLedger.sol` in the `contracts` directory.

You can view the contract on the [Celo Sepolia Block Explorer](https://celo-sepolia.blockscout.com/address/0xb51fc31becE3850415Dc97eB2B06C30499E7D1bb).
